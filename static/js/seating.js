...
const users = [
	...
	{id: 2, nickname: '0dez', email: 'ben.falconer@gmail.com'},
	{id: 3, nickname: 'Some very very super duper long name asdfaf asf asf af;jaklsfj lkaslfkjalksfjoisajo flkdasjflkjalkfdjaks olfjlkasjf lkajsflk jalkjflaskfj lkajflkjalkdfjl kajfklda jflalj dflkasjfl kdsajlkf lkas fdjlkaljklkasf jlkasjflkasjlkfjlaksdfjl alkfjaslkf jalsfjlaksjfljalfjasld', email: 'a@b.com'},
...
function dragSetPosition(event) {
	...
	popupDom.style.left = offsetLeft + clientX + 2 + 'px';
	popupDom.style.top = offsetTop + clientY + 2 + 'px';
}
